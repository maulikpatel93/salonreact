...
import { setVoucherPreview, VoucherGridViewApi, VoucherStoreApi } from "store/slices/voucherSlice";
                ...
                <form noValidate onSubmit={formik.handleSubmit}>
                  <div className="drawer-header px-md-4 px-3 py-3 d-flex flex-wrap align-items-center">
                    ...
                    <div className="ms-auto">
                      <a className="close btn me-1 cursor-pointer" onClick={handleCloseAddVoucherForm}>
                        {t("Cancel")}
                      </a>
