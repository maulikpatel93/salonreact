...
const view = (values) => {
  ...
  const action = page ? `afterlogin/client/clientmembership?page=${page}` : `afterlogin/client/clientmembership`;
  const data = {
    auth_key: auth_key,
    action: action,
...
const clientmembershipApiController = {
  view,
};
export default clientmembershipApiController;
