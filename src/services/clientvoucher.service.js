...
const view = (values) => {
  ...
  const action = page ? `afterlogin/client/clientvoucher?page=${page}` : `afterlogin/client/clientvoucher`;
  const data = {
    auth_key: auth_key,
    action: action,
...
const clientvoucherApiController = {
  view,
};
export default clientvoucherApiController;
